...
//!
//! * Quaternions representing combined rotations can be generated by the Mul operator
//!
//! * The quaternion when created from an axis and angle represents a *right-handed*
//!   rotation of a 3D vector about the given axis by the given angle
//!
//! # Examples:
//!
//! ```rust
