...
//! # Note:
//!
//! * Solver works with fixed-size matrix class.
//! * Dynamic arrays are not supported, as currently math operations for these return
//!   a `Result` type, not `Self`.  This makes implementation more complex.
//!
...
// For implementation with fixed matrices
mod matrix_impl;
...
/// ODE Solvers
///
/// This module provides a set of ODE solvers.
pub mod solvers {
